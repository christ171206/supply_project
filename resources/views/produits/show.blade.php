...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    @if($produit->vendeur)
        <div class="card p-8 mb-12">
            <h3 class="text-lg font-semibold text-gray-900 mb-6">Contacter le Vendeur</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="p-5 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    @if($produit->vendeur->phone)
                        <div class="mb-3">
                            <p class="text-xs text-gray-600">Tél</p>
                            <a href="tel:{{ $produit->vendeur->phone }}" class="text-primary-600 font-semibold text-sm hover:text-primary-700">
                    ...
                    <div>
                        ...
                        <a href="mailto:{{ $produit->vendeur->email }}" class="text-primary-600 font-semibold text-sm hover:text-primary-700 break-all">
                ...
                <div>
                    @auth
                        <form action="{{ route('messages.store') }}" method="POST" class="space-y-3">
                            ...
                            <textarea
                                ...
                                required
                                class="textarea-field text-sm @error('contenu') border-danger-500 @enderror"
                    ...
                    @else
                        <div class="text-center p-6 bg-gray-50 rounded-lg">
                            <p class="text-gray-600 text-sm mb-4">Connectez-vous pour contacter</p>
                            <a href="{{ route('login') }}" class="btn-primary inline-block">
                                Se Connecter
                            </a>
                        </div>
