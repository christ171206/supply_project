    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
        ...
        <a href="{{ route('produits.catalogue', ['categorie' => $categorie->id]) }}" class="group card-hover">
            <div class="relative h-40 mb-4 rounded-xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-50">
                ...
                @else
                    <div class="flex flex-col items-center justify-center h-full bg-gradient-to-br from-primary-100 to-accent-50">
                        <svg class="w-12 h-12 text-primary-500 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                        </svg>
                        <p class="text-xs text-gray-600 font-medium">Pas d'image</p>
                    </div>
                @endif
